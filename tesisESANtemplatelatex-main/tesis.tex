...
\begin{titlepage}
	...
	\begin{center}
			...
			\textbf{Desarrollo de un Sistema de detección haciendo uso de Deep Learning y Visión por Computadora para el pre-diagnóstico del Cáncer de Piel de tipo Melanoma}
			\vspace*{8ex}\\	
