...
\fancyhead[L]{\changefont Desarrollo de un Sistema de detección haciendo uso de Deep Learning y Computer Vision para el pre-diagnóstico del Cáncer de Piel de tipo Melanoma}
...
\begin{titlepage}
	...
	\begin{center}
			...
			\textbf{Desarrollo de un Sistema de detección haciendo uso de Deep Learning y Computer Vision para el pre-diagnóstico del Cáncer de Piel de tipo Melanoma}
			\vspace*{8ex}\\	
